...
void CFlowCompOutput::SetHistoryOutputFields(CConfig *config){
  ...
  AddHistoryOutput("SOUND_SPEED", "Avg_SoundSpeed", ScreenOutputFormat::SCIENTIFIC, "FLOW_COEFF", "Average local speed of sound in the domain", HistoryFieldType::COEFFICIENT);
  /// END_GROUP
